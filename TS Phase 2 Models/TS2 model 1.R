...
n<-c( 
  ...
  ,"UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product" # NB they named this UM_AllChan_AllProd_PaidSearch_sum_NonBrand_product_Impressions which is not consistent with other models
  ,"UM_AllChan_AllProd_ProgrammaticTot_Impressions_L1" # lag created above
  ,"UM_AllChan_AllProd_NonProgTotal_Impressions"
  ,"UM_AllChan_AllProd_SocialFBInsta_Impressions"
  ,"UM_AllChan_1P_SocialFBInsta_Impressions"
#  ,"UM_AllChan_HSIn_Traditional_Media_SpendGross_Clean" # they included cinema which I left out and so my results differ at the first decimal point
...
#  ,"UM_AllChan_Brand_Traditional_Media_SpendGross_Clean"
  ...
  ,"UM_AllChan_1P_VP5_StepchangeInitial"
  ,"UM_AllChan_3P_VP6_Stepchange" # added to DB. Has p value over 0.4 and I would have left it out
...
ds.prep.model$UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product <- adstock_it(ds.prep.model$UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product, 0.1, 0.9, 500)
ds.prep.model$UM_AllChan_AllProd_ProgrammaticTot_Impressions_L1 <- adstock_it(ds.prep.model$UM_AllChan_AllProd_ProgrammaticTot_Impressions_L1, 0.1, 0.9, 500)
ds.prep.model$UM_AllChan_AllProd_NonProgTotal_Impressions <- adstock_it(ds.prep.model$UM_AllChan_AllProd_NonProgTotal_Impressions, 0.9, 0.99, 100)
...
ds.prep.model$UM_AllChan_1P_SocialFBInsta_Impressions <- adstock_it(ds.prep.model$UM_AllChan_1P_SocialFBInsta_Impressions, 0.1, 0.9, 500)
ds.prep.model$UM_AllChan_HSIn_All_SpendGross_2L2 <- adstock_it(ds.prep.model$UM_AllChan_HSIn_All_SpendGross_2L2, 0.1, 0.9, 500)
ds.prep.model$UM_AllChan_Brand_All_SpendGross_2L2 <- adstock_it(ds.prep.model$UM_AllChan_Brand_All_SpendGross_2L2, 0.1, 0.9, 500)
ds.prep.model$Comp_AllChan_Media_Spend <- adstock_it(ds.prep.model$Comp_AllChan_Media_Spend, 0.1, 0.6, 300)
ds.prep.model$UM_AllChan_1P_VP5_StepchangeInitial <- adstock_it(ds.prep.model$UM_AllChan_1P_VP5_StepchangeInitial, 0.1, 0.01445, 500)
