# Model 12	UM_Retailind_3P_Sales_Units_OE	
...
n<-c(  
  ...
  ,"UM_AllChan_3P_LosWochos_Stepchange"
...
#  ,"UM_AllChan_3P_Traditional_Media_SpendGross_Clean"
  ,"UM_AllChan_3P_All_SpendGross_2L2" # see above
  ,"UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product" # see above
  ...
  ,"UM_Retailind_3P_HSIn_CPO1b_SpendPerOE_D"
...
ds.prep.model$UM_AllChan_Brand_All_SpendGross_2L2 <- adstock_it(ds.prep.model$UM_AllChan_Brand_All_SpendGross_2L2, 0.1, 0.1, 500)
ds.prep.model$UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product <- adstock_it(ds.prep.model$UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product, 0.9, 0.9, 500)
