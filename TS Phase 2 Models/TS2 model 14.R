# Model 14	UM_Digitalind_3P_Sales_Units_OE	
...
ds.prep <- slide(ds.prep, Var = "UM_AllChan_3p_WhitemailXWOWI_Number", NewVar = "UM_AllChan_3p_WhitemailXWOWI_Number_L2",slideBy = -2)
ds.prep$UM_AllChan_3p_WhitemailXWOWI_Number_L2[is.na(ds.prep$UM_AllChan_3p_WhitemailXWOWI_Number_L2)] <- 0
...
#  ,"UM_AllChan_AllProd_PaidSearch_sum_NonBrand_product_Impressions"
  ,"UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product"
  ...
  ,"UM_AllChan_3p_WhitemailXWOWI_Number_L2"
...
ds.prep.model$UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product <- adstock_it(ds.prep.model$UM_AllChan_AllProd_PaidSearch_sum_Impressions_NonBrand_Product, 0.1, 0.5, 1000)
ds.prep.model$UM_AllChan_AllProd_ProgrammaticTot_Impressions_L1 <- adstock_it(ds.prep.model$UM_AllChan_AllProd_ProgrammaticTot_Impressions_L1, 0.1, 0.85, 300)
ds.prep.model$UM_AllChan_AllProd_NonProgTotal_Impressions <- adstock_it(ds.prep.model$UM_AllChan_AllProd_NonProgTotal_Impressions, 0.1, 0.6, 1000)
ds.prep.model$UM_AllChan_AllProd_HSIN_TV_SocialFBInsta_Impressions <- adstock_it(ds.prep.model$UM_AllChan_AllProd_HSIN_TV_SocialFBInsta_Impressions, 0.1, 0.8, 100)

ds.prep.model$UM_AllChan_2p3p_WhitemailXWOWI_Number <- adstock_it(ds.prep.model$UM_AllChan_2p3p_WhitemailXWOWI_Number, 0.1, 0.2, 100)
ds.prep.model$UM_AllChan_3p_WhitemailXWOWI_Number_L2 <- adstock_it(ds.prep.model$UM_AllChan_3p_WhitemailXWOWI_Number_L2, 0.1, 0.6, 100)
ds.prep.model$Comp_AllChan_HSIn_Spend <- adstock_it(ds.prep.model$Comp_AllChan_HSIn_Spend, 0.1, 0.2, 500)
...
ds.prep.model$UM_AllChan_HSIn_All_SpendGross_2L2 <- adstock_it(ds.prep.model$UM_AllChan_HSIn_All_SpendGross_2L2, 0.1, 0.28, 300)
ds.prep.model$UM_AllChan_Brand_All_SpendGross_2L2 <- adstock_it(ds.prep.model$UM_AllChan_Brand_All_SpendGross_2L2, 0.1, 0.3, 1000)
