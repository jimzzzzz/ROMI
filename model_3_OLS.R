...
target <- var_adstocked$UM_AllChan_HSIn_All_SpendGross_2L2 * 1261.01236149
...
write.csv(t(var_adstocked[,names(var_adstocked) %in% independent_n]), file = "model_3_adstock.csv")
